...
def preload_datasets(paths: List[str]) -> str:
	...
	waste tokens describing dataset content repeatedly in agent responses.
...
tools = [list_csv_files, preload_datasets, get_dataset_summaries, call_dataframe_method, evaluate_regression_dataset, evaluate_classification_dataset]
